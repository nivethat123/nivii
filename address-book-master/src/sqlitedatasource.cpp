...
void SQLiteDataSource::fillContactFromRow(sqlite3_stmt *s, Contact& c)
{
    ...
    c.gender = reinterpret_cast<const char*>(sqlite3_column_text(s, 6));
    c.nationality = reinterpret_cast<const char*>(sqlite3_column_text(s, 7));
...
ErrorInfo SQLiteDataSource::addContact(const Contact& c)
{
    ...
    sqlite3_bind_text(insertStatement.get(), 6, c.gender.c_str(), -1, SQLITE_STATIC);
    sqlite3_bind_text(insertStatement.get(), 7, c.nationality.c_str(), -1, SQLITE_STATIC);
...
ErrorInfo SQLiteDataSource::updateContact(Contact::ContactId id, const Contact& c)
{
    ...
    sqlite3_bind_text(updateStatement.get(), 6, c.gender.c_str(), -1, SQLITE_STATIC);
    sqlite3_bind_text(updateStatement.get(), 7, c.nationality.c_str(), -1, SQLITE_STATIC);
